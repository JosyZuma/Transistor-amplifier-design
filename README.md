...
Built to understand DC biasing and gain in a single-stage BJT amplifier  and to diagnose, from first principles, why a build's measured behavior doesn't match its calculated design.
